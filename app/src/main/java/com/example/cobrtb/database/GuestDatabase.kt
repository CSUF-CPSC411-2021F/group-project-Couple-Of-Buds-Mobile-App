...
/**
 * Manages the database that stores the Guest table and its entitites.
...
abstract class GuestDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: GuestDatabase? = null // This class
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        GuestDatabase::class.java, // Your database class
                        "guest_database"
                    )
